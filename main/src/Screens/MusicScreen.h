...
// Now-playing screen for iOS media (AMS). Reads Service::Media (AMS::Client) for track/artist/
// state and drives it with the physical buttons: Up = next, Down = prev, Select = play/pause,
